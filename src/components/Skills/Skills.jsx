...
const skills = [
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: "React", icon: <DiReact className="text-blue-500" /> },
      { name: "Firebase", icon: <DiFirebase className="text-red-600" /> },
...
const Skills = () => {
  return (
    <div
      className="flex flex-col justify-center items-center px-4 text-gray-200 pb-8 md:py-12 max-w-[1000px] mx-auto"
      id="skills"
    >
      <Reveal>
